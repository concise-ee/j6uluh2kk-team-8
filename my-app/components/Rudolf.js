...
export const Rudolf = ({christmas}) => {
  return (
    <>
      ...
      <div className="credits">Created with <span className="love"></span> by <a href="https://codepen.io/ivanodintsov">Ivan
        Odintsov</a>  &nbsp;&nbsp;&middot;&nbsp;&nbsp;  Original by <a
        href="https://dribbble.com/shots/2421804-Merry-Christmas">Artua</a></div>
    </>
  )
}